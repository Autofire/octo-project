...
namespace ReachBeyond.VariableObjects.Editor {
	...
	public class AudioSourceRefEditor : Base.Editor.RefEditor { }

	[CustomPropertyDrawer(typeof(AudioSourceConstReference))]
	public class AudioSourceConstRefEditor : Base.Editor.ConstRefEditor { }
}
