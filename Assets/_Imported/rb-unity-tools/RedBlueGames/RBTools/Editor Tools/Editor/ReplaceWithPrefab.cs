            ...
            if (GUILayout.Button("Replace Selected"))
            {
                if (this.prefabObject != null)
                {
                    ...
                    foreach (Transform transformToCopy in Selection.transforms)
                    {
                        ...
                        GameObject prefab = PrefabUtility.GetCorrespondingObjectFromSource(this.prefabObject) as GameObject;
                        //var prefabType = PrefabUtility.GetPrefabType(this.prefabObject);
						PrefabAssetType pAssetType = PrefabUtility.GetPrefabAssetType(prefabObject);
						PrefabInstanceStatus pInstanceStatus = PrefabUtility.GetPrefabInstanceStatus(prefabObject);


                        //if (prefabType == PrefabType.PrefabInstance)
						if(pInstanceStatus != PrefabInstanceStatus.NotAPrefab)
                        {
                        ...
                        else if (pAssetType != PrefabAssetType.NotAPrefab)
                        {
